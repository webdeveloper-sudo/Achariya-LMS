...
export const sampleData = {
  ...
  students: [
    ...
    },
    {
      ...
      status: "Active",
      lastLoginDate: "2025-12-09",
      streakFreezeUsed: false,
    },
    {
      id: 4,
      name: "Divya Menon",
      email: "divya.m@achariya.org",
      school_id: 1,
      class: "10-B",
      completion: 88,
      quiz_avg: 90,
  ...
  modules: [
    ...
    },
    {
      ...
      order: 3,
      completion_rate: 80,
      explainerUrl: "/explainers/probability-statistics.mp4",
    }, // POC
    ...
    },
    {
      ...
      order: 3,
      completion_rate: 85,
      explainerUrl: "/explainers/electromagnetism.mp4",
    }, // POC
    ...
    },
    {
      ...
      order: 3,
      completion_rate: 80,
      explainerUrl: "/explainers/dynamic-programming.mp4",
    }, // POC
      ...
      questions: [
        {
          ...
          correctAnswer: 1,
          explanation: "The unit is Coulomb (C)",
        },
        {
          id: 2,
          ...
          correctAnswer: 1,
          explanation: "Faraday's law: changing magnetic flux induces EMF",
        },
        {
          id: 3,
        ...
        {
          id: 4,
          question: "What carries current in metals?",
          options: ["Protons", "Neutrons", "Electrons", "Photons"],
          correctAnswer: 2,
          explanation: "Electrons carry current in metals",
        },
        {
          id: 5,
  ...
  badges: [
    {
      ...
      activity: "Quiz completion under 60 seconds",
    },
    {
      id: 2,
      code: "HIGH_PERFORMER",
      name: "High Performer",
      description: "Achieve 95%+ scores",
      activity: "Scored 95%+ on 5 quizzes",
    },
    {
      id: 3,
      code: "CONSISTENT",
    ...
    },
    {
      ...
      activity: "Top 3 in class ranking",
    },
    {
      id: 5,
      code: "MENTOR",
...
export const getTopBadgeHolders = (limit = 5) => {
  const allUsers = [
    ...sampleData.students.map((s) => ({
      ...s,
      type: "Student",
      badgeCount: s.gamification?.badges?.length || 0,
    })),
    ...sampleData.teachers.map((t) => ({
      ...t,
      type: "Teacher",
      badgeCount: t.badges || 0,
    })),
  ];
  return allUsers.sort((a, b) => b.badgeCount - a.badgeCount).slice(0, limit);
};
...
export const getStudentDetails = (studentId: number) => {
  ...
  const studentEnrollments = sampleData.enrollments.filter(
