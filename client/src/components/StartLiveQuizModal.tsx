...
import { X, Play, Users, Clock, AlertTriangle, Check } from "lucide-react";
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-yellow-50 border-2 border-yellow-400 rounded-lg p-4 flex items-start gap-3">
            ...
            <p className="text-sm text-yellow-800">
              <strong>Note:</strong> Once started, all students in the selected
              class will see the quiz alert immediately. The quiz will auto-end
