  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      content: studentName
        ? `👋 Hi ${
            studentName.split(" ")[0]
          }! I'm your AI Study Assistant. I can help answer questions about your enrolled courses, explain concepts, and guide you through your learning. What would you like to know?`
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const errorMessage: Message = {
        role: "assistant",
        content:
          "I'm having trouble right now. Please try again or ask your teacher for help.",
        source: "❌ Error",
      };
