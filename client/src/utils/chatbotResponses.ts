...
const courseDocuments: Record<number, Record<string, string>> = {
  ...
  3: {
    ...
    quiz: "**English Literature Quiz Guidelines:**\n\n• 15 questions\n• 120-second time limit\n• Tests: Comprehension, analysis, interpretation\n• Focus: Themes, characters, literary devices\n\n**Tips:**\n[Check] Read passages carefully\n[Check] Understand context\n[Check] Know character motivations\n[Check] Identify literary techniques\n[Check] Think author's purpose\n[Check] Support with evidence!",
  },
};
...
export const generateChatbotResponse = (
  ...
  const personalInfoPattern =
    /\b(my name|who am i|who i am|who do you think i am|about me|more about me|tell me about|myself|what grade|which grade|which class|what class|my information|my details|my profile|do you know me|what do you know about me|information about me)\b/;
    ...
    for (const [keyword, answer] of Object.entries(courseDoc)) {
      if (normalizedQuery.includes(keyword)) {
        ...
        return {
          role: "assistant",
          content: answer,
          source: `[Book] ${course?.title} - Course Materials`,
        };
      }
    }
  }
  ...
  if (
    ...
    const courses = sampleData.courses.filter((c) =>
